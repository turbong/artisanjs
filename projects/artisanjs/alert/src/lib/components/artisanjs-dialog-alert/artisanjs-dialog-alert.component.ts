...
@Component({
  selector: 'artisanjs-dialog-alert',
  templateUrl: './artisanjs-dialog-alert.component.html',
  styleUrls: ['./artisanjs-dialog-alert.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class artisanjsDialogAlertComponent implements OnInit, AfterViewInit {

  @ViewChildren(DynamicDirective)
  appDynamic: QueryList<DynamicDirective>;

  constructor(
    public dialogRef: MatDialogRef<artisanjsDialogAlertComponent>,
